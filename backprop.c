...
void bpnn_adjust_weights(double *delta, double ndelta, double *ly, double nly, double **w, double **oldw, double eta, double  momentum)
{
  double new_dw;
  int k, j;
